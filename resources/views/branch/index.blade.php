    ...
    @section('content')
        <div class="post d-flex flex-column-fluid mb-10" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="card-title">
                            <div class="d-flex align-items-center position-relative my-1 me-5">
                                ...
                                <input type="text" class="form-control w-250px ps-13"
                                    placeholder="{{ __('labels.search_branch') }}" name="search"
                                    value="{{ request('search') }}" id="InputSearch"
                                    data-search-url="{{ route('branch.index') }}" />
                            </div>
                        </div>
                        <div class="card-toolbar">
                            @can('branch.create')
                                <button class="btn btn-light-success me-3" data-bs-toggle="modal"
                                    data-bs-target="#import_branch">
                                    <i class="fs-3 bi bi-database-down"></i>{{ __('labels.import') }}</button>
                                <a href="{{ route('branch.create') }}" class="btn btn-light-primary">
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                ...
                                <tbody class="fw-semibold text-gray-600 tablebody">
                                    @include('branch.row', ['data' => $data, 'i' => $i])
                                </tbody>
                            </table>
                ...
                <div class="modal fade" id="import_branch" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        <div class="modal-content">
                            <div class="modal-header" id="modal_import_branch_header">
                                <h2 class="fw-bold">{{ __('labels.import_branch') }}</h2>
                            ...
                            <div class="modal-body px-5 my-7">
                                <form id="FormId" class="form ajax-form-submit" action="{{ route('ImportBranch') }}"
                                    enctype="multipart/form-data" method="POST" data-dismiss-modal="import_branch"
                                    data-preloader="false" data-refresh="false" data-reset="true">
                                    @csrf
                                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="modal_import_branch_scroll"
                                        data-kt-scroll="true" data-kt-scroll-activate="true"
                                        data-kt-scroll-max-height="auto"
                                        data-kt-scroll-dependencies="#modal_import_branch_header"
                                        data-kt-scroll-wrappers="#modal_import_branch_scroll" data-kt-scroll-offset="300px">
                                        ...
                                        <span class="text-muted mt-6">
                                            ...
                                            department_name, department_email, department_contact, branch_name,
                                            branch_email, branch_contact, branch_address.
                                            {{ __('labels.download_sample_file') }}
                                            <a href="{{ url('/') }}/public/empty-files/empty-branch.xlsx"
