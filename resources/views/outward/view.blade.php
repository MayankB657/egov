                            ...
                            <div class="col-lg-4">
                                <div class="fv-row mb-7 form-group">
                                    <label class="fs-6 fw-semibold form-label mb-2">
                                        <span class="required">{{ __('labels.outward_no') }}</span>
                                    </label>
                                    <input type="text" class="form-control" readonly value="{{ $data->outward_no }}">
                                </div>
                            </div>
                            @if ($data->inward_no != null)
                                <div class="col-lg-4">
                                    <div class="fv-row mb-7 form-group">
                                        <label class="fs-6 fw-semibold form-label mb-2">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div id="DivFile" class="{{ $data->letter_type == 'File' ? '' : 'd-none' }}">
                                    <div class="fv-row mb-7 form-group">
                                        ...
                                        <input class="form-control" readonly name="rack_no" data-bvalidator="required"
                                            value="{{ $data->rack_no }}" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                ...
                                <div id="DivByHand" class="{{ $data->received_by == 'By hand' ? '' : 'd-none' }}">
                                    <div class="fv-row mb-7 form-group">
                                        ...
                                        <input class="form-control" readonly name="by_hand_name" data-bvalidator="required"
                                ...
                                <div id="DivEmail" class="{{ $data->received_by == 'Email' ? '' : 'd-none' }}">
                                    <div class="fv-row mb-7 form-group">
                                        ...
                                        <input class="form-control" readonly name="email" data-bvalidator="required"
                                            value="{{ $data->email }}" />
                                    </div>
                                </div>
                                <div id="DivCourier" class="{{ $data->received_by == 'Courier' ? '' : 'd-none' }}">
                                    <div class="fv-row mb-7 form-group">
                                        ...
                                        <input class="form-control" readonly name="courier_name" data-bvalidator="required"
                                    ...
                                    <div class="fv-row mb-7 form-group">
                                        ...
                                        <input class="form-control" readonly name="tracking_id" data-bvalidator="required"
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-lg-4">
                                <div class="fv-row mb-7 form-group">
                                    ...
                                    <input class="form-control" readonly name="date" data-bvalidator="required"
                        ...
                        <div class="row mb-1">
                            <div class="col-lg-4">
                                <div class="fv-row mb-7 form-group">
                                    ...
                                    <textarea name="description" readonly rows="4" class="form-control">{{ $data->description }}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="fv-row mb-7 form-group">
                                    ...
                                    <textarea name="comment" readonly rows="4" class="form-control">{{ $data->comment }}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-4">
