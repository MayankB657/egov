<x-app-layout>
    ...
    @section('content')
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="fv-row mb-7 form-group">
                                ...
                                <select class="form-select fw-bold" data-placeholder="{{ __('labels.select_letter') }}"
                                    data-bvalidator="required" name="letter_id" data-control="select2">
                                    <option hidden></option>
                                    @foreach ($inwards as $letter)
                                        <option value="{{ $letter->id }}">{{ $letter->inward_no }}
                                            ({{ $letter->subject->name }})
                                        </option>
                                    @endforeach
                                </select>
        ...
        <div class="post d-flex flex-column-fluid mb-10" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <div class="card card-flush card-newOutward">
                    <form action="{{ route('outward-letter.store') }}" autocomplete="off" method="POST"
                                        ...
                                        <div id="DivLetter" class="d-none">
                                            <div class="fv-row mb-7 form-group">
                                                ...
                                                <input class="form-control" name="letter_no"
                                                    placeholder="{{ __('labels.enter_letter_no') }}"
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-lg-4">
                                    <div class="fv-row mb-7 form-group">
                                        ...
                                        <select class="form-select fw-bold"
                                            data-placeholder="{{ __('labels.select_branch') }}" data-bvalidator="required"
                                ...
                                <div class="col-lg-4">
                                    <div class="fv-row mb-7 form-group">
                                        ...
                                        <select class="form-select fw-bold"
                                            data-placeholder="{{ __('labels.select_subject') }}" data-bvalidator="required"
                                ...
                                <div class="col-lg-4">
                                    <div class="fv-row mb-7 form-group">
                                        ...
                                        <input class="form-control" name="authority_name"
                                            placeholder="{{ __('labels.enter_authority_name') }}" />
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-1">
                                ...
                                <div class="col-lg-4">
                                    <div class="fv-row mb-7 form-group">
                                        ...
                                        <textarea name="comment" rows="4" class="form-control" placeholder="{{ __('labels.enter_comment') }}"></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="fv-row mb-7 form-group">
                                        ...
                                        <input class="form-control" type="file" name="media_files[]" multiple
                                            ...
                                            data-bvalidator-msg="{{ __('labels.allowed_file_types') }} png, jpg, jpeg or pdf." />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card card-flush card-exstingOutward d-none">
                </div>
    ...
    @push('js')
        <script>
            $(document).on('change', 'select[name="department_id"]', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        branch_id.select2({
                            placeholder: "{{ __('labels.select_branch') }}",
                        });
            ...
            $(document).on('change', 'select[name="letter_id"]', function() {
                var letter_id = $(this).val();
                $.ajax({
                    type: "GET",
                    url: base_url + "/get-outward-content/" + letter_id,
                    success: function(response) {
                        if (response.status == true) {
                            $('.card-newOutward').addClass('d-none');
                            $('.card-exstingOutward').html(response.html);
                            $('.card-exstingOutward').find('form').bValidator();
                            $('.card-exstingOutward').removeClass('d-none');
                            $('.card-exstingOutward').find('select[data-control="select2"]').each(
                                function() {
                                    $(this).select2();
                                });
                            ...
                            $('.card-exstingOutward').find('input.flatDatepickr').each(function() {
